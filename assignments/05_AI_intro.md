...
- **Task 6: Ethics reflection** — Either Option A (a comment block of at least 3–5 sentences at the bottom of `project_05.py`) **or** Option B (a 2–3 minute video link pasted as a comment) responding to at least two of the three listed questions. Both formats earn full credit — do not require the comment-block form if a video link is provided.
